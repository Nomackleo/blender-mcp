...
def generate_hyper3d_model_via_images(
    ...
    For LOCAL_API mode, the addon forwards either local image paths or URLs to the configured local adapter.
    ...
    1. First use the following tools to verify if the following integrations are enabled:
        ...
        3. Hyper3D(Rodin)
            ...
            - For objects/models, do the following steps:
                ...
                If Hyper3D is in LOCAL_API mode, the same MCP tools still apply; the addon forwards the request to the configured local adapter and normalizes the responses for the MCP client.
